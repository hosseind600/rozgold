    ...
    <div className="mt-10">
      <div className="  flex justify-between mb-5">
        <div className="flex flex-col">
          <span className="text-gray-600 text-sm">جدید ترین</span>
          <span className="font-bold text-[#d9af73]"> محصــولات  رزگلد</span>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-3">
        ...
        <div className="rounded-xl bg-white shadow-lg flex flex-col p-2">
          <img src="/samples/5.png" alt="" />
          <div className="">
            <h3>گردنبند طلا مدل P9</h3>
        ...
        <div className="rounded-xl bg-white shadow-lg flex flex-col p-2">
          <img src="/samples/7.png" alt="" />
          <div className="">
            <h3>گردنبند طلا طرح بال فرشته </h3>
            <div className="flex items-center justify-between text-sm text-gray-600">
              <div>2.700.000 تومان</div>
              <div className="w-[40px] h-[40px] flex items-center justify-center text-[#d9af73] transition-all text-sm rounded-lg bg-[#d9af75] hover:bg-[#d9a275] hover:text-[#f8e3b4]">
                <svg
        ...
        <div className="rounded-xl bg-white shadow-lg flex flex-col p-2">
          <img src="/samples/9.png" alt="" />
          <div className="">
            <h3>دستبند طلا مدل K45</h3>
            <div className="flex items-center justify-between text-sm text-gray-600">
              <div>2.700.000 تومان</div>
              <div className="w-[40px] h-[40px] flex items-center justify-center text-[#d9af73] transition-all text-sm rounded-lg bg-[#d9af75] hover:bg-[#d9a275] hover:text-[#f8e3b4]">
                <svg
        ...
        <div className="rounded-xl bg-white shadow-lg flex flex-col p-2">
          <img src="/samples/10.png" alt="" />
          <div className="">
            <h3>دستبند طلا مدل 26</h3>
            <div className="flex items-center justify-between text-sm text-gray-600">
              <div>2.700.000 تومان</div>
              <div className="w-[40px] h-[40px] flex items-center justify-center text-[#d9af73] transition-all text-sm rounded-lg bg-[#d9af75] hover:bg-[#d9a275] hover:text-[#f8e3b4]">
                <svg
